...
-- NOTE: The table `new_table_example` is intentionally created with only an `id` column as a placeholder for future development.
-- Additional columns will be added in subsequent migrations as requirements are defined.
